...
Foam::optical::semiTransSurfaceMixedFvPatchScalarField::
...
void Foam::optical::semiTransSurfaceMixedFvPatchScalarField::
updateCoeffs()
{
    if (this->updated())
    {
...
void Foam::optical::semiTransSurfaceMixedFvPatchScalarField::write
(
    Ostream& os
) const
{
