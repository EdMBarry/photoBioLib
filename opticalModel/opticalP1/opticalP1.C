...
Foam::optical::P1::P1(const volScalarField& intensity)
:
...
void Foam::optical::P1::calculate()
{
  ...
  //  E_ = absorptionEmission_->E();
    ...
    (
      ...
      - fvm::Sp(a_, G_)
 //    ==
 //     - 4.0*(e_*optical::sigmaSB*pow4(T_) + E_)
    );
...
/*
Foam::tmp<Foam::volScalarField> Foam::optical::P1::Rp() const
{
    ...
    (
        ...
        (
            ...
            4.0*absorptionEmission_->eCont()*optical::sigmaSB
        )
    );
}
