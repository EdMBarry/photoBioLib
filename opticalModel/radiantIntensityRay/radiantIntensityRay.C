...
Foam::label Foam::optical::radiantIntensityRay::rayId(0);

const Foam::word
Foam::optical::radiantIntensityRay::intensityPrefix("ILambda");


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::optical::radiantIntensityRay::radiantIntensityRay
(
...
Foam::scalar Foam::optical::radiantIntensityRay::correct()
{
...
void Foam::optical::radiantIntensityRay::addIntensity()
{
